		...
		<div class="form-group">
			...
			<form:errors path="*"/> 
				...
				<p>
					...
					<form:input class="form-control" id="title" path="title" placeholder="placeholder"/>
				</p>
				
				<p>
					<form:label path="author" for="author">author</form:label>
					<form:errors path="author" />
					<form:input class="form-control" id="author" path="author" placeholder="placeholder"/>
				</p>
				
				<p>
					<form:label path="mythoughts" for="mythoughts">My Thoughts:</form:label>
					<form:errors path="mythoughts" />
					<form:input class="form-control" id="mythoughts" path="mythoughts" placeholder="placeholder"/>
				</p>
